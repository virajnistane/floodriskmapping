...
def test_plot_flood_with_coastbuffer_creates_file(tmp_dem_path, tmp_flood_mask_path, tmp_path):
...
def test_plot_flood_with_coastbuffer_custom_settings(tmp_dem_path, tmp_flood_mask_path, tmp_path):
...
def test_plot_flood_with_coastbuffer_closes_figure(tmp_dem_path, tmp_flood_mask_path, tmp_path):
